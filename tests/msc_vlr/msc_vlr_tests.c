...
int __real_ranap_iu_tx_release(struct ue_conn_ctx *ctx, const struct RANAP_Cause *cause);
int __wrap_ranap_iu_tx_release(struct ue_conn_ctx *ctx, const struct RANAP_Cause *cause)
{
